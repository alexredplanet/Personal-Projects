...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname abstraction-parameterization) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; Apply fn to every item in list
...
(check-expect (map2 string-length (list "hi" "hello"))
              (list 2 5))
...
;; Filter a list of numbers based on the given predicate
